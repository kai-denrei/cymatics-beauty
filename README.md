...
| **v3** | Audio-reactive — uploaded tracks first, optional local YouTube ingest behind a CLI flag. | In progress (generative studio with arrangement timeline — see [`v1/studio.html`](./v1/studio.html)) |
