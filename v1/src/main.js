...
import { Particles }                from "./particles.js?v=89493e79";
import { wireUI }                   from "./ui.js?v=89493e79";
import { AudioEngine, drawScope, modeFrequency } from "./audio.js?v=89493e79";
import { setupLive }                from "./live.js?v=89493e79";
...
const worker = new Worker(new URL("./worker.js?v=89493e79", import.meta.url), { type: "module" });
worker.onmessage = (e) => {
  const msg = e.data;
  if (msg.type === "field") {
