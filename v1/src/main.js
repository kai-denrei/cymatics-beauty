...
import { Particles }                from "./particles.js?v=7ecf85a4";
import { wireUI }                   from "./ui.js?v=7ecf85a4";
import { AudioEngine, drawScope, modeFrequency } from "./audio.js?v=7ecf85a4";
import { setupLive }                from "./live.js?v=7ecf85a4";
...
const worker = new Worker(new URL("./worker.js?v=7ecf85a4", import.meta.url), { type: "module" });
worker.onmessage = (e) => {
  const msg = e.data;
  if (msg.type === "field") {
